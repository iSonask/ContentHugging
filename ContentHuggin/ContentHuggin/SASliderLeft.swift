...
class SASliderLeft: UIView {
    ...
    */
    ...
    override func draw(_ rect: CGRect) {
        ...
        let roundedRectanglePath = UIBezierPath(roundedRect: roundedRectangleRect, byRoundingCorners: [.topLeft, .bottomLeft], cornerRadii: CGSize(width: 5, height: 5))
